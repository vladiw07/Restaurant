...
export default function Home() {
  ...
  return (
    <div className="text-white">
      {/* ========== HERO – No background, just particles from body ========== */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 md:pt-24">
        {/* No gradient, no overlay – clean dark background */}

        {/* Content container */}
        <div className="relative z-10 w-full flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto py-12 md:py-16">
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              className="inline-block px-4 py-1.5 border border-[#D4AF37]/30 rounded-full text-xs tracking-wider text-[#D4AF37] bg-black/20 backdrop-blur-sm"
            >
              EST. 2018 · MICHELIN STAR ★
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-playfair font-bold leading-[1.1]"
            >
              Vermilion
            </motion.h1>
            ...
            >
              Dinner nightly · Private dining · Seasonal tasting menus
            </motion.p>
